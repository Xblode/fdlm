...
export function MobileHeroContent() {
  return (
    <>
      ...
      <div
        id="hero-ui"
        className="mobile-hero-height pointer-events-none fixed top-[var(--mobile-header-height)] right-0 left-0 z-[5] flex items-end justify-start px-6 pb-14 md:hidden"
      >
        <div
          id="hero-ui-content"
